...
// import 'package:sehaone/core/services/error_logger.dart';
...
//       }
//     } catch (e) {
//       recordError(error, stack: error.stackTrace, reason: e.toString(), fatal: true);
...
//     } else {
//       recordError(error, stack: error.stackTrace, reason: error.toString(), fatal: true);
//       return DataSource.defaultError.getFailure();
//     }
//   }
//
