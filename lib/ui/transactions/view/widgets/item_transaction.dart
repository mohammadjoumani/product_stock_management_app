...
import 'package:product_stock_management_app/core/util/extension/date_extension.dart';
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(flex: 1, child: _itemCell(transaction.productName ?? '')),
            Expanded(flex: 1, child: _itemCell(transaction.quantityChange.toString())),
            Expanded(flex: 2, child: _itemCell(transaction.date!.getDate())),
            Expanded(flex: 1, child: _itemCell(transaction.date!.getTime())),
          ],
        ),
      ),
    );
